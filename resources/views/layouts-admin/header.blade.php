<head>
    ...
    <title>@yield('title') - RadenFebri</title>
    ...
    <link rel="stylesheet" href="{{ asset('template') }}/vendors/choices.js/choices.min.css"/>
    <link rel="stylesheet" href="{{ asset('template') }}/vendors/summernote/summernote-lite.min.css">
